package com.example.multidex_issue;
...
import com.example.multidex_issue.R;
...
public class SplashActivity extends Activity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        if (firstLaunch) {
            firstLaunch = false;
            setupSplash();
            App.loadAsynchronously("com.example.multidex_issue.MainActivity",
                                   new Runnable() {
                                       @Override
                                       public void run() {
                                           proceed();
    ...
    public void proceed() {
        startActivity(new Intent("com.example.multidex_issue.MAIN"));
        finish();
    }
